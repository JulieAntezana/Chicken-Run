...
from game.scripting.move_fox_action import MoveFoxAction
...
def main():
    ...
    #Fox
    fox_size = Point(35, 28)
    
    #Fox images
    fox_images = [Image(FOX_ONE)]
    
    #Fox in the Grass
    cast.add_actor("fox", Fox(1, FOX_LANE, fox_images, fox_size)) 
