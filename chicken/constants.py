...
FOX_ONE = "chicken/assets/images/10.png"
FOX_TWO = "chicken/assets/images/14.png"
FOX_THREE = "chicken/assets/images/15.png"



CHICKEN_IMAGES = [f"chicken/assets/images/{n}.png" for n in range(1, 7)]
CHICKEN_RATE = 1
